  ...
  return (
    <div className={`bg-white p-3 rounded-lg text-sm flex ${className}`}>
      <div className='w-1/2'>
        ...
        <input id={amountInputId} type="number" className='outline-none w-full bg-transparent py-1.5' placeholder='0' disabled={amountDisable} value={amount} onChange={(e) => onAmountChange && onAmountChange(e.target.value)} />
      </div>
